...
const CreateDropOff = ({ user, ...props }) => {
  ...
  return (
    <div className={style.Container}>
      <section>
        <div>
          <p>Help the community and start a new recycling point today!</p>
          <p>Fill the form and add all the details of the new location.</p>
          <p>
            Soon our Team will contact you to validate your idoneity and will
            abilitate your new Futura recycling point!
          </p>
        </div>
      </section>
      <Form onSubmit={handleSubmit(onSubmit)} className={style.Form}>
        <Form.Group id={style.firstInput}>
          <Form.Input
            {...register("name", {
              required: true,
              minLength: 3,
